    ...
    return (
        <>
            <BrandProvider brand="icloud">
                ...
                <br />
                <br />
                <TextArea style={{ width: 360, height: 150 }} placeholder="请输入" />
                <br />
                <br />
                <p>密码输入框</p>
                <Input.Password style={{ width: 360 }} placeholder="请输入" />
                <br />
                <br />
                <p>清空按钮输入框</p>
                <Input allowClear style={{ width: 360 }} placeholder="请输入" defaultValue="产品线名称" />
                <br />
                <br />
                <p>带有前后缀的输入框</p>
                <Input prefix="￥" suffix="RMB" style={{ width: 360 }} />
                <br />
                <br />
                <Input.Group compact>
                    <Input
                        ...
                        placeholder="Email"
                    />
                    <Select defaultValue="RMB" style={{ width: '80px' }}>
                ...
                <br />
                <br />
                <Input.Search allowClear withSuffixIcon style={{ width: 360 }} placeholder="请输入" />
                <p></p>
                <p></p>
                <h3>错误状态</h3>
                <Blockquote>
...
export const Size = () => {
    return (
        <>
            ...
            <h3>高度</h3>
            <Input style={{ width: 240 }} placeholder="small size" size="small" />
            <p />
            <Input style={{ width: 240 }} placeholder="default size" />
            <p></p>
            <h3>宽度</h3>
...
export const Complete = () => {
    ...
    return (
        <>
            ...
            <Input.Group compact>
                <Select defaultValue="Sign Up" style={{ width: '80px' }}>
            ...
            >
                ...
                <Form.Item
                    ...
                    help={'格式错误，请按提示规则录入'}
                >
                    <Input.Search withSuffixIcon placeholder="input search text" style={{ width: 240 }} />
                </Form.Item>
                <Form.Item
                    validateMessageLayout="inline"
                    label="产品线名称"
    ...
    return (
        <>
            <BrandProvider brand="icloud">
                ...
                <Input.Search placeholder="搜索提示文案" style={{ width: 240 }} />
            </BrandProvider>
        </>
    );
};
