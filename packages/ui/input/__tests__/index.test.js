...
describe('Input', () => {
  ...
  it('select()', () => {
    ...
    wrapper.find('Input').at(0).instance().select();
  });
  ...
  it('set mouse cursor position', () => {
    ...
    expect(wrapper.find('Input').instance().input.selectionStart).toEqual(5);
    expect(wrapper.find('Input').instance().input.selectionEnd).toEqual(5);
  });
});
