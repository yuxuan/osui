...
describe('Avatar Render', () => {
    ...
    it('should handle onError correctly', () => {
        ...
        expect(div.querySelector('img').getAttribute('src')).toBe(
            LOAD_FAILURE_SRC
        );
    ...
    it('should show image on success after a failure state', () => {
        ...
        expect(
            wrapper.find('.ant-avatar-string').prop('style')
        ).not.toHaveProperty('opacity', 0);
    ...
    it('support onMouseEnter', () => {
        ...
        const wrapper = mount(
            <Avatar onMouseEnter={onMouseEnter}>TestString</Avatar>
        );
