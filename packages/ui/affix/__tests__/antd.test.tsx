...
import Affix, {AffixProps, AffixState} from '../src';
import {sleep} from '../../../tests/utils';

const events: Partial<Record<
    keyof HTMLElementEventMap,
    (ev: Partial<Event>) => void
>> = {};
...
describe('Affix Render', () => {
    ...
    it('Anchor render perfectly', async () => {
        ...
        affixMounterWrapper = mount(<AffixMounter />, {
        ...
        expect(
            affixMounterWrapper.instance().affix.state.affixStyle
        ).toBeFalsy();
    ...
    it('updatePosition when offsetTop changed', async () => {
        ...
        affixMounterWrapper = mount(
            <AffixMounter offsetTop={0} onChange={onChange} />,
            {
                attachTo: document.getElementById('mounter'),
            }
        );
        ...
        expect(affixMounterWrapper.instance().affix.state.affixStyle?.top).toBe(
            0
        );
    ...
    describe('updatePosition when target changed', () => {
        it('function change', () => {
            ...
            expect(affixWrapper.instance().state.placeholderStyle).toBe(
                undefined
            );
        });
    });
