...
exports.presetColors = {
    ...
    '--btn-default-hover-background': 'var(--color-gray-3)',
    '--btn-default-hover-border-color': 'var(--color-gray-5)',
    '--btn-default-active-background': 'var(--color-gray-4)',
    '--btn-default-loading-background': 'var(--btn-disable-bg)',
    '--btn-default-loading-border-color': 'var(--btn-disable-border)',
    '--btn-default-loading-color': 'var(--btn-disable-color)',
    '--btn-primary-hover-background': 'var(--color-brand-5)',
    '--btn-primary-hover-border-color': 'var(--color-brand-5)',
    '--btn-primary-loading-color': 'var(--btn-disable-color)',
    '--btn-strong-hover-background': 'var(--color-brand-2)',
    '--btn-strong-active-background': 'var(--color-brand-3)',
