...
const buttonColors = {
    ...
    '--btn-only-icon-active-border-color': 'var(--color-brand-4)',
    '--btn-only-icon-active-color': 'var(--theme-primary-color)',
    '--btn-only-icon-disable-bg': 'var(--theme-component-bg)',
    '--btn-only-icon-disable-border-color': 'var(--theme-component-bg)',
    ...
    '--btn-only-icon-loading-bg': 'var(--theme-component-bg)',
    '--btn-only-icon-loading-border-color': 'var(--theme-component-bg)',
