export default {
    // antd
    '--btn-disable-bg': 'var(--color-gray-11)',
    '--btn-disable-border': 'var(--color-gray-8)',
    ...
    '--btn-default-active-bg': 'var(--color-gray-8)',
    ...
    '--btn-default-hover-bg': 'var(--color-gray-9)',
    '--btn-default-hover-border-color': 'var(--color-gray-7)',
