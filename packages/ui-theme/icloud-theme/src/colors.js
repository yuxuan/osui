...
const buttonColors = {
    ...
    // type link
    '--btn-link-bg': 'var(--theme-component-bg)',
    '--btn-link-border-color': 'var(--theme-component-bg)',
    '--btn-link-color': 'var(--theme-text-color)',
    '--btn-link-active-bg': 'var(--color-brand-1)',
    '--btn-link-active-border-color': 'var(--theme-primary-color)',
    '--btn-link-active-color': 'var(--theme-primary-color)',
    '--btn-link-disable-bg': 'var(--btn-disable-bg)',
    '--btn-link-disable-border-color': 'var(--btn-disable-border)',
    '--btn-link-disable-color': 'var(--btn-disable-color)',
    '--btn-link-focus-bg': 'var(--theme-component-bg)',
    '--btn-link-focus-border-color': 'var(--theme-primary-color)',
    '--btn-link-focus-color': 'var(--theme-primary-color)',
    '--btn-link-hover-bg': 'var(--theme-component-bg)',
    '--btn-link-hover-border-color': 'var(--theme-primary-color-hover)',
    '--btn-link-hover-color': 'var(--theme-primary-color)',
    '--btn-link-loading-bg': 'var(--btn-link-focus-bg)',
    '--btn-link-loading-border-color': 'var(--btn-link-focus-border-color)',
    '--btn-link-loading-color': 'var(--btn-link-focus-color)',
    // type only-icon
    '--btn-only-icon-bg': 'var(--theme-component-bg)',
    '--btn-only-icon-border-color': 'var(--theme-component-bg)',
    '--btn-only-icon-color': 'var(--theme-text-color)',
    '--btn-only-icon-active-bg': 'var(--theme-component-bg)',
    '--btn-only-icon-active-border-color': 'var(--theme-component-bg)',
    ...
    '--btn-only-icon-focus-bg': 'var(--theme-component-bg)',
    '--btn-only-icon-focus-border-color': 'var(--theme-component-bg)',
    '--btn-only-icon-focus-color': 'var(--theme-primary-color)',
    '--btn-only-icon-hover-bg': 'var(--theme-component-bg)',
    '--btn-only-icon-hover-border-color': 'var(--theme-component-bg)',
...
exports.presetColors = {
    ...
    '--theme-error-color-active': 'var(--color-error-6)',
    '--theme-error-color-hover': 'var(--color-error-6)',
    '--theme-error-color': 'var(--color-error-6)',
    '--theme-heading-color': 'var(--color-gray-9)',
    '--theme-info-color-active': 'var(--color-info-6)',
    '--theme-info-color-hover': 'var(--color-info-6)',
    ...
    '--theme-success-color-active': 'var(--color-success-6)',
    '--theme-success-color-hover': 'var(--color-success-6)',
    '--theme-success-color': 'var(--color-success-6)',
    '--theme-text-color-secondary': 'var(--color-gray-8)',
    '--theme-text-color': 'var(--color-gray-9)',
    '--theme-warning-color-active': 'var(--color-warning-6)',
    '--theme-warning-color-hover': 'var(--color-warning-6)',
