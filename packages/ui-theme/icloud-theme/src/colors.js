...
exports.tagColors = {
    // 靛蓝 Blue
    '--color-indigo-1': '#ebf1ff',
    '--color-indigo-2': '#D6E4FF',
    '--color-indigo-3': '#ADCAFF',
    '--color-indigo-4': '#85B1FF',
    '--color-indigo-5': '#5C9AFF',
    '--color-indigo-6': '#317FF5',
    '--color-indigo-7': '#1F68CF',
    '--color-indigo-8': '#1152A8',
    '--color-indigo-9': '#073E82',
    '--color-indigo-10': '#002B5C',
    // 绛紫 Purple
...
exports.rotatingColors = {
    ...
    '--color-rotating-3': '#27327a',
    '--color-rotating-4': '#fbbe04',
    '--color-rotating-5': '#545fc8',
    '--color-rotating-6': '#04c1ba',
    '--color-rotating-7': '#8a58bc',
    '--color-rotating-8': '#f38900',
    '--color-rotating-9': '#00756d',
    '--color-rotating-10': '#E673C0',
};
...
exports.presetColors = {
    ...
    '--input-focus-background-color': 'var(--color-indigo-1)',
    ...
    '--checkbox-border-color': 'var(--color-gray-7)',
    ...
    '--checkbox-disabled-bg': 'var(--color-gray-3)',
    '--checkbox-disabled-border-color': 'var(--color-gray-4)',
    '--checkbox-disabled-color': 'var(--color-gray-6)',
    ...
    // 计算公示：100vh - header高度 - footer高度 - 上下要留50px
