...
exports.presetColors = {
    ...
    '--btn-default-hover-background': 'var(--theme-component-bg)',
    '--btn-default-hover-border-color': 'var(--theme-primary-color-hover)',
    '--btn-default-active-background': 'var(--color-brand-1)',
    '--btn-default-loading-background': 'var(--theme-component-bg)',
    '--btn-default-loading-border-color': 'var(--theme-primary-color)',
    '--btn-default-loading-color': 'var(--theme-primary-color)',
    '--btn-primary-hover-background': 'var(--theme-primary-color-hover)',
    '--btn-primary-hover-border-color': 'var(--theme-primary-color-hover)',
    '--btn-primary-loading-color': 'var(--color-gray-1)',
    '--btn-strong-hover-background': 'var(--color-brand-1)',
    '--btn-strong-active-background': 'var(--color-brand-1)',
