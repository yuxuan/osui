export default {
    ...
    '--alert-no-icon-padding': '4px 16px',
    '--alert-padding': '4px 10px 4px 38px',
    ...
    '--btn-primary-active-bg': 'var(--color-gray-8)',
    '--btn-primary-active-border-color': 'var(--color-gray-8)',
    ...
    '--checkbox-checked-disabled-bg': 'var(--theme-disabled-bg)',
    '--checkbox-checked-disabled-border-color': 'var(--theme-disabled-bg)',
    ...
    '--pagination-item-bg-active': 'var(--color-gray-2)',
    ...
    '--picker-basic-cell-active-with-range-color': 'var(--color-gray-2)',
    '--picker-basic-cell-disabled-bg': 'rgba(0, 0, 0, 0.04)',
    '--picker-basic-cell-hover-color': 'var(--theme-bg-color-base)',
    '--picker-basic-cell-hover-with-range-color': 'var(--color-gray-3)',
