export default {
    ...
    '--border-color-base': 'var(--color-gray-9)',
    ...
    '--btn-default-border': 'var(--color-gray-7)',
    ...
    '--checkbox-border-color': 'var(--color-gray-8)',
    ...
    '--checkbox-checked-disabled-bg': 'var(--color-gray-10)',
    '--checkbox-checked-disabled-border-color': 'var(--color-gray-8)',
    '--checkbox-checked-disabled-inner-color': 'var(--color-gray-7)',
    ...
    '--collapse-content-bg': 'var(--color-gray-11)',
    ...
    '--collapse-expand-icon-color': 'var(--color-gray-5)',
    '--collapse-header-bg': 'var(--color-gray-9)',
    ...
    '--drawer-footer-border-top-color': 'var(--color-gray-8)',
    ...
    '--form-item-extra-color': 'var(--color-gray-5)',
    ...
    '--menu-inline-submenu-bg': 'var(--color-gray-10)',
    ...
    '--pagination-prev-next-icon-color': 'var(--color-gray-5)',
    ...
    '--radio-button-checked-disabled-bg': 'var(--color-gray-8)',
    '--radio-button-checked-disabled-border-color': 'var(--color-gray-8)',
    '--radio-button-checked-disabled-color': 'var(--color-gray-7)',
    '--radio-button-color': 'var(--btn-default-color)',
    '--radio-button-disabled-bg': 'var(--color-gray-10)',
    '--radio-button-disabled-border-color': 'var(--color-gray-7)',
    ...
    '--radio-checked-disabled-bg': 'var(--color-gray-10)',
    '--radio-checked-disabled-border-color': 'var(--color-gray-8)',
    '--radio-checked-disabled-color': 'var(--color-gray-7)',
    '--radio-disabled-bg': 'var(--color-gray-10)',
    ...
    '--radio-disabled-dot-color': 'var(--color-gray-7)',
    ...
    '--select-arrow-color': 'var(--color-gray-5)',
    ...
    '--select-item-selected-bg': 'var(--color-gray-11)',
    ...
    '--select-multiple-item-disabled-bg': 'var(--color-gray-9)',
    ...
    '--slider-rail-background-color': 'var(--color-gray-8)',
    '--slider-rail-background-color-hover': 'var(--color-gray-8)',
    ...
    '--switch-active-bg': 'var(--color-gray-4)',
    ...
    '--switch-disable-bg': 'var(--color-gray-9)',
    '--switch-disabled-opacity': '0.4',
    '--switch-handle-disable-bg': 'var(--color-gray-6)',
    '--switch-hover-bg': 'var(--color-gray-5)',
    ...
    '--table-border-color': 'var(--color-gray-8)',
    ...
    '--table-footer-bg': 'var(--color-gray-10)',
    '--table-footer-color': 'var(--theme-heading-color)',
    '--table-header-bg': 'var(--color-gray-10)',
    '--table-header-bg-sm': '#fafafa',
    '--table-header-border-bottom-color': 'transparent',
    '--table-header-cell-border-right': '1px solid var(--color-gray-11)',
    '--table-header-cell-split-color': 'rgba(0, 0, 0, 0.06)',
    '--table-header-color': 'var(--color-gray-4)',
    ...
    '--tabs-top-before': '2px solid var(--color-gray-8)',
    '--tabs-border-bottom': '1px solid var(--color-gray-8)',
    '--tabs-tab-color': 'var(--color-gray-2)',
    '--tabs-card-bg': 'var(--color-gray-9)',
    ...
    '--tag-font-color': 'var(--color-gray-2)',
    ...
    '--tag-icon-color': 'var(--color-gray-5)',
